...
from paypal.standard.conf import RECEIVER_EMAILS, RECEIVER_EMAIL, POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT
    ...
    def verify(self, item_check_callable=None):
        ...
        if not self.flag:
            if self.is_transaction():
                ...
                if self.receiver_email != RECEIVER_EMAIL and not self.receiver_email in RECEIVER_EMAILS:
